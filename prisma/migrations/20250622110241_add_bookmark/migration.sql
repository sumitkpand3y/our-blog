/*
  ...
  - Added the required column `authorId` to the `PostTag` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "PostTag" ADD COLUMN     "authorId" TEXT NOT NULL;
...
-- CreateIndex
CREATE INDEX "PostTag_authorId_idx" ON "PostTag"("authorId");
